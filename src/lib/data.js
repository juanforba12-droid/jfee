...
const LOCK_ELIM = '2026-06-29T19:00:00+02:00'
...
export const PARTIDOS_ELIMINATORIAS = [
  {id:101, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Sáb 28 Jun', local:'Sudáfrica', vis:'Canadá',  lockTime:LOCK_101},
  {id:102, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Sáb 28 Jun', local:'Brasil', vis:'Japón',  lockTime:LOCK_ELIM},
  {id:103, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Dom 29 Jun', local:'Alemania', vis:'Paraguay',  lockTime:LOCK_ELIM},
  {id:104, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Dom 29 Jun', local:'C. de Marfil', vis:'Noruega',  lockTime:LOCK_ELIM},
  {id:105, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Lun 30 Jun', local:'Francia', vis:'Suecia',  lockTime:LOCK_ELIM},
  {id:106, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Lun 30 Jun', local:'Países Bajos', vis:'Marruecos',  lockTime:LOCK_ELIM},
  {id:107, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Mié 1 Jul',  local:'México', vis:'Ecuador',  lockTime:LOCK_ELIM},
  {id:108, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Mié 1 Jul',  local:'Inglaterra', vis:'RD Congo',  lockTime:LOCK_ELIM},
  {id:113, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Mié 1 Jul',  local:'Bélgica', vis:'Senegal',  lockTime:LOCK_ELIM},
  {id:114, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Mié 1 Jul',  local:'Estados Unidos', vis:'Bosnia-Herz.',  lockTime:LOCK_ELIM},
  {id:115, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Jue 2 Jul',  local:'España', vis:'Austria',  lockTime:LOCK_ELIM},
  {id:116, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Jue 2 Jul',  local:'Portugal', vis:'Croacia',  lockTime:LOCK_ELIM},
  {id:117, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Jue 2 Jul',  local:'Suiza', vis:'Argelia',  lockTime:LOCK_ELIM},
  {id:118, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Vie 3 Jul',  local:'Australia', vis:'Egipto',  lockTime:LOCK_ELIM},
  {id:119, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Vie 3 Jul',  local:'Argentina', vis:'Cabo Verde',  lockTime:LOCK_ELIM},
  {id:120, fase:'dieciseisavos', jornada:'Dieciseisavos', fecha:'Vie 3 Jul',  local:'Colombia', vis:'Ghana',  lockTime:LOCK_ELIM},
  {id:201, fase:'octavos', jornada:'Octavos', fecha:'Sáb 4 Jul',  local:'G1',  vis:'G2',  lockTime:LOCK_ELIM},
  {id:202, fase:'octavos', jornada:'Octavos', fecha:'Sáb 4 Jul',  local:'G3',  vis:'G4',  lockTime:LOCK_ELIM},
  {id:203, fase:'octavos', jornada:'Octavos', fecha:'Dom 5 Jul', local:'G5',  vis:'G6',  lockTime:LOCK_ELIM},
  {id:204, fase:'octavos', jornada:'Octavos', fecha:'Dom 5 Jul', local:'G7',  vis:'G8',  lockTime:LOCK_ELIM},
  {id:205, fase:'octavos', jornada:'Octavos', fecha:'Lun 6 Jul', local:'G9',  vis:'G10', lockTime:LOCK_ELIM},
  {id:206, fase:'octavos', jornada:'Octavos', fecha:'Lun 6 Jul', local:'G11', vis:'G12', lockTime:LOCK_ELIM},
  {id:207, fase:'octavos', jornada:'Octavos', fecha:'Mar 7 Jul', local:'G13', vis:'G14', lockTime:LOCK_ELIM},
  {id:208, fase:'octavos', jornada:'Octavos', fecha:'Mar 7 Jul', local:'G15', vis:'G16', lockTime:LOCK_ELIM},
  {id:301, fase:'cuartos', jornada:'Cuartos', fecha:'Mar 15 Jul', local:'C1',  vis:'C2',  lockTime:LOCK_ELIM},
  {id:302, fase:'cuartos', jornada:'Cuartos', fecha:'Mar 15 Jul', local:'C3',  vis:'C4',  lockTime:LOCK_ELIM},
  {id:303, fase:'cuartos', jornada:'Cuartos', fecha:'Mié 16 Jul', local:'C5',  vis:'C6',  lockTime:LOCK_ELIM},
  {id:304, fase:'cuartos', jornada:'Cuartos', fecha:'Mié 16 Jul', local:'C7',  vis:'C8',  lockTime:LOCK_ELIM},
  {id:401, fase:'semis', jornada:'Semifinales', fecha:'Mar 22 Jul', local:'S1', vis:'S2',  lockTime:LOCK_ELIM},
  {id:402, fase:'semis', jornada:'Semifinales', fecha:'Mié 23 Jul', local:'S3', vis:'S4',  lockTime:LOCK_ELIM},
  {id:501, fase:'tercero', jornada:'3er Puesto', fecha:'Sáb 26 Jul', local:'Perdedor SF1', vis:'Perdedor SF2', lockTime:LOCK_ELIM},
  {id:601, fase:'final', jornada:'Final', fecha:'Dom 27 Jul', local:'Ganador SF1', vis:'Ganador SF2', lockTime:LOCK_ELIM},
]
